...
require (
	github.com/3lvia/libraries-go/pkg/hashivault v0.4.0
	github.com/3lvia/libraries-go/pkg/kafkaclient v0.3.0
	github.com/3lvia/libraries-go/pkg/mschema v0.1.0
...
require (
	...
	github.com/hashicorp/cap v0.14.0 // indirect
